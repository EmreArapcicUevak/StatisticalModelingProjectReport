...
\begin{document}
	...
	\section{Discussion and Intrepretation}
		...
		\subsection{Conclusion}
			...
			\begin{figure}[h!]
				\centering
				\href{https://github.com/EmreArapcicUevak/StatisticalModelingProjectReport}{\qrcode[height=.4\textwidth]{https://github.com/EmreArapcicUevak/StatisticalModelingProjectReport}}
